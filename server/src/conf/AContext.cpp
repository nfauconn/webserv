...
std::string const&					AContext::autoindex() const { return this->_autoindex; }
size_t								AContext::maxBodySize() const { return this->_maxBodySize; }
std::string const &					AContext::pwd() const { return this->_pwd; }
std::string const &					AContext::root() const { return this->_root; }
std::map<int, std::string> const &	AContext::errorPages() const { return this->_errorPages; }
std::vector<std::string> const & 	AContext::index() const { return this->_index; }
std::vector<std::string> const &	AContext::authorizedMethods() const { return this->_authorizedMethods; }
std::string const&					AContext::uploadFolder() const { return this->_uploadFolder; }
