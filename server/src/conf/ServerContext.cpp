...
std::map<std::string, int> const &				ServerContext::listen() const { return this->_listen; }
std::map<std::string, LocationContext> const &	ServerContext::locations() const { return this->_locations; }
std::vector<std::string> const &				ServerContext::serverNames() const { return this->_serverNames; }
int												ServerContext::port() const { return this->_listen.begin()->second; }
